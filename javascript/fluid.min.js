  ...
  return function(e) {
    ...
    Object.defineProperty(r, "__esModule", {
      ...
      r.behavior = o = function(e) {
        for (var r = 1; r < arguments.length; r++) {
          ...
          r % 2 ? t(n, !0).forEach(function(r) {
            i(e, r, n[r])
          }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(n)) : t(n).forEach(function(r) {
    ...
    e.exports = function() {
      function e(r) {
        ...
        }(this, e), this.PARAMS = t.behavior, r.width = r.clientWidth, r.height = r.clientHeight, this.canvas = r;
        var n = (0, i.initWebGL)(),
          o = n.programs,
          a = n.webGL,
          u = n.colorFormats,
          v = n.pointers;
        this.programs = o, this.webGL = a, this.colorFormats = u, this.pointers = v
      }
      var r, n, v;
      return r = e, (n = [{
        key: "activate",
        value: function() {
          (0, i.activator)(this.canvas, this.webGL, this.colorFormats, this.programs, this.pointers)
        }
      }, {
        key: "deactivate",
        value: function() {}
        ...
        value: function(e) {
          this.PARAMS = function(e) {
            for (var r = 1; r < arguments.length; r++) {
              var n = null != arguments[r] ? arguments[r] : {};
              r % 2 ? o(n, !0).forEach(function(r) {
                a(e, r, n[r])
              }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(n)) : o(n).forEach(function(r) {
                Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(n, r))
              })
            }
            return e
          }({}, this.PARAMS, {}, e), (0, t.setBehaviors)(this.PARAMS)
        }
      }, {
        key: "setAsBackground",
        value: function() {
          var e = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0];
          canvas.style.zIndex = e ? "-99" : "0", canvas.style.position = e ? "absolute" : "relative"
        }
      }, {
        key: "applyBackground",
        value: function(e, r) {
          var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null,
            t = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : this.canvas;
          switch (e = e.toLowerCase(), this.PARAMS.transparent = !0, e) {
            case "gradient":
              i();
              break;
            case "image":
            ...
            case "solid":
            default:
              this.PARAMS.transparent = !1, this.PARAMS.background_color = r
          }
          ...
          function o() {
            t.style.backgroundImage = "url('" + r + "')", n && (t.style.backgroundRepeat = n.repeat ? "repeat" : "no-repeat", t.style.backgroundPosition = n.position ? n.position : "center", t.style.backgroundSize = n.size ? n.size : "contain", t.style.backgroundColor = n.color ? n.color : "none")
          }
          this.reset()
        }
      }, {
    ...
    Object.defineProperty(r, "__esModule", {
      ...
      var r = canvas.getContext("webgl2", t.DRAWING_PARAMS),
        n = !!r;
      n || (r = canvas.getContext("webgl", t.DRAWING_PARAMS) || canvas.getContext("experimental-webgl", t.DRAWING_PARAMS));
      var i = function() {
        var e, t, i, o, a;
        n ? (r.getExtension("EXT_color_buffer_float"), a = r.getExtension("OES_texture_float_linear")) : (o = r.getExtension("OES_texture_half_float"), a = r.getExtension("OES_texture_half_float_linear"));
        var u = n ? r.HALF_FLOAT : o.HALF_FLOAT_OES;
        r.clearColor(0, 0, 0, 1), n ? (e = v(r.RGBA16F, r.RGBA, u), t = v(r.RG16F, r.RG, u), i = v(r.R16F, r.RED, u)) : (e = v(r.RGBA, r.RGBA, u), t = v(r.RGBA, r.RGBA, u), i = v(r.RGBA, r.RGBA, u));
        ...
        function v(e, n, t) {
          ...
          r.bindFramebuffer(r.FRAMEBUFFER, o), r.framebufferTexture2D(r.FRAMEBUFFER, r.COLOR_ATTACHMENT0, r.TEXTURE_2D, i, 0);
          var a = r.checkFramebufferStatus(r.FRAMEBUFFER);
          if (!(a === r.FRAMEBUFFER_COMPLETE)) switch (e) {
            case r.R16F:
      ...
      /Mobi|Android/i.test(navigator.userAgent) && (t.behavior.render_shaders = !1);
      i.supportLinearFiltering || (t.behavior.render_shaders = !1, t.behavior.render_bloom = !1);
      var o = {
        ...
        displayShading: a(r.FRAGMENT_SHADER, t.SHADER_SOURCE.displayShading),
        displayBloomShading: a(r.FRAGMENT_SHADER, t.SHADER_SOURCE.displayBloomShading),
        bloomPreFilter: a(r.FRAGMENT_SHADER, t.SHADER_SOURCE.bloomPreFilter),
        ...
        advectionManualFiltering: a(r.FRAGMENT_SHADER, t.SHADER_SOURCE.advectionManualFiltering),
        ...
        gradientSubtract: a(r.FRAGMENT_SHADER, t.SHADER_SOURCE.gradientSubtract)
      };

      function a(e, n) {
        var t = r.createShader(e);
        if (r.shaderSource(t, n), r.compileShader(t), !r.getShaderParameter(t, r.COMPILE_STATUS)) throw r.getShaderInfoLog(t);
        return t
      }
      return {
        programs: (u = i.supportLinearFiltering, {
          ...
          displayBloomShadingProgram: new m(o.baseVertex, o.displayBloomShading, r),
          ...
          advectionProgram: new m(o.baseVertex, u ? o.advection : o.advectionManualFiltering, r),
          ...
          gradientSubtractProgram: new m(o.baseVertex, o.gradientSubtract, r)
        }),
        webGL: r,
        colorFormats: i,
        pointers: e
      ...
      v = !0;
      var m, c, s, d, g, p, b, h, S, y, R = t.behavior,
        T = [],
        E = [],
        x = (r.bindBuffer(r.ARRAY_BUFFER, r.createBuffer()), r.bufferData(r.ARRAY_BUFFER, new Float32Array([-1, -1, -1, 1, 1, 1, 1, -1]), r.STATIC_DRAW), r.bindBuffer(r.ELEMENT_ARRAY_BUFFER, r.createBuffer()), r.bufferData(r.ELEMENT_ARRAY_BUFFER, new Uint16Array([0, 1, 2, 0, 2, 3]), r.STATIC_DRAW), r.vertexAttribPointer(0, 2, r.FLOAT, !1, 0, 0), r.enableVertexAttribArray(0), function(e) {
      ...
      function D() {
        ...
        m = u.width, c = u.height, s = v.width, d = v.height, g = g ? A(g, s, d, t.internalFormat, t.format, e, a) : J(s, d, t.internalFormat, t.format, e, a), p = p ? A(p, m, c, i.internalFormat, i.format, e, a) : J(m, c, i.internalFormat, i.format, e, a), y = _(l.width, l.height, t.internalFormat, t.format, e, a), b = _(m, c, o.internalFormat, o.format, e, r.NEAREST), h = _(m, c, o.internalFormat, o.format, e, r.NEAREST), S = J(m, c, o.internalFormat, o.format, e, r.NEAREST), T.length = 0;
      ...
      function _(e, n, t, i, o, a) {
        ...
        r.bindTexture(r.TEXTURE_2D, u), r.texParameteri(r.TEXTURE_2D, r.TEXTURE_MIN_FILTER, a), r.texParameteri(r.TEXTURE_2D, r.TEXTURE_MAG_FILTER, a), r.texParameteri(r.TEXTURE_2D, r.TEXTURE_WRAP_S, r.CLAMP_TO_EDGE), r.texParameteri(r.TEXTURE_2D, r.TEXTURE_WRAP_T, r.CLAMP_TO_EDGE), r.texImage2D(r.TEXTURE_2D, 0, t, e, n, 0, i, o, null);
        var v = r.createFramebuffer();
        return r.bindFramebuffer(r.FRAMEBUFFER, v), r.framebufferTexture2D(r.FRAMEBUFFER, r.COLOR_ATTACHMENT0, r.TEXTURE_2D, u, 0), r.viewport(0, 0, e, n), r.clear(r.COLOR_BUFFER_BIT), {
          texture: u,
          fbo: v,
          width: e,
          height: n,
          attach: function(e) {
            return r.activeTexture(r.TEXTURE0 + e), r.bindTexture(r.TEXTURE_2D, u), e
          }
        }
      }

      function A(e, n, t, i, a, u, v) {
        return e.read = function(e, n, t, i, a, u, v) {
          var l = _(n, t, i, a, u, v);
          return o.clearProgram.bind(), r.uniform1i(o.clearProgram.uniforms.uTexture, e.attach(0)), r.uniform1f(o.clearProgram.uniforms.value, 1), x(l.fbo), l
        }(e.read, n, t, i, a, u, v), e.write = _(n, t, i, a, u, v), e
      }
      ...
      function U(e) {
        ...
        var t = {
            ...
            height: 1,
            attach: function(e) {
              return r.activeTexture(r.TEXTURE0 + e), r.bindTexture(r.TEXTURE_2D, n), e
            }
          },
          i = new Image;
        return i.src = e, i.onload = function() {
          t.width = i.width, t.height = i.height, r.bindTexture(r.TEXTURE_2D, n), r.texImage2D(r.TEXTURE_2D, 0, r.RGB, r.RGB, r.UNSIGNED_BYTE, i)
        }, t
      }

      function w(n) {
        R.render_bloom && function(e, n) {
          ...
          var i = R.threshold * R.soft_knee + 1e-4,
            ...
            u = 2 * i,
            v = .25 / i;
          r.uniform3f(o.bloomPreFilterProgram.uniforms.curve, a, u, v), r.uniform1f(o.bloomPreFilterProgram.uniforms.threshold, R.threshold), r.uniform1i(o.bloomPreFilterProgram.uniforms.uTexture, e.attach(0)), r.viewport(0, 0, t.width, t.height), x(t.fbo), o.bloomBlurProgram.bind();
          for (var l = 0; l < T.length; l++) {
            var m = T[l];
            r.uniform2f(o.bloomBlurProgram.uniforms.texelSize, 1 / t.width, 1 / t.height), r.uniform1i(o.bloomBlurProgram.uniforms.uTexture, t.attach(0)), r.viewport(0, 0, m.width, m.height), x(m.fbo), t = m
          }
          r.blendFunc(r.ONE, r.ONE), r.enable(r.BLEND);
          for (var f = T.length - 2; f >= 0; f--) {
            var c = T[f];
            r.uniform2f(o.bloomBlurProgram.uniforms.texelSize, 1 / t.width, 1 / t.height), r.uniform1i(o.bloomBlurProgram.uniforms.uTexture, t.attach(0)), r.viewport(0, 0, c.width, c.height), x(c.fbo), t = c
          }
          r.disable(r.BLEND), o.bloomFinalProgram.bind(), r.uniform2f(o.bloomFinalProgram.uniforms.texelSize, 1 / t.width, 1 / t.height), r.uniform1i(o.bloomFinalProgram.uniforms.uTexture, t.attach(0)), r.uniform1f(o.bloomFinalProgram.uniforms.intensity, R.intensity), r.viewport(0, 0, n.width, n.height), x(n.fbo)
        }(g.read, y), null != n && R.transparent ? r.disable(r.BLEND) : (r.blendFunc(r.ONE, r.ONE_MINUS_SRC_ALPHA), r.enable(r.BLEND));
        ...
        if (r.viewport(0, 0, t, i), !R.transparent) {
          ...
          r.uniform4f(o.colorProgram.uniforms.color, a.r / 255, a.g / 255, a.b / 255, 1), x(n)
        }
        if (null == n && R.transparent && (o.backgroundProgram.bind(), r.uniform1f(o.backgroundProgram.uniforms.aspectRatio, e.width / e.height), x(null)), R.render_shaders) {
          var u = R.render_bloom ? o.displayBloomShadingProgram : o.displayShadingProgram;
          if (u.bind(), r.uniform2f(u.uniforms.texelSize, 1 / t, 1 / i), r.uniform1i(u.uniforms.uTexture, g.read.attach(0)), R.render_bloom) {
            r.uniform1i(u.uniforms.uBloom, y.attach(1)), r.uniform1i(u.uniforms.uDithering, P.attach(2));
            var v = Z(P, t, i);
            r.uniform2f(u.uniforms.ditherScale, v.x, v.y)
          }
        } else {
          var l = R.render_bloom ? o.displayBloomProgram : o.displayProgram;
          if (l.bind(), r.uniform1i(l.uniforms.uTexture, g.read.attach(0)), R.render_bloom) {
            r.uniform1i(l.uniforms.uBloom, y.attach(1)), r.uniform1i(l.uniforms.uDithering, P.attach(2));
            var m = Z(P, t, i);
      ...
      function L() {
        var e = function(e, r, n) {
          var t, i, o, a, u, v, l, m;
          switch (a = Math.floor(6 * e), v = n * (1 - r), l = n * (1 - (u = 6 * e - a) * r), m = n * (1 - (1 - u) * r), a % 6) {
            case 0:
              t = n, i = m, o = v;
              break;
            case 1:
      ...
      function Z(e, r, n) {
        ...
        e.width == e.clientWidth && e.height == e.clientHeight || (e.width = e.clientWidth, e.height = e.clientHeight, D());
        ! function() {
          E.length > 0 && O(E.pop());
          for (var e = 0; e < a.length; e++) {
            var r = a[e];
            r.moved && (F(r.x, r.y, r.dx, r.dy, r.color), 1 !== e && (r.moved = !1))
          }
        ...
        R.paused || function(e) {
          r.disable(r.BLEND), r.viewport(0, 0, m, c), o.curlProgram.bind(), r.uniform2f(o.curlProgram.uniforms.texelSize, 1 / m, 1 / c), r.uniform1i(o.curlProgram.uniforms.uVelocity, p.read.attach(0)), x(h.fbo), o.vorticityProgram.bind(), r.uniform2f(o.vorticityProgram.uniforms.texelSize, 1 / m, 1 / c), r.uniform1i(o.vorticityProgram.uniforms.uVelocity, p.read.attach(0)), r.uniform1i(o.vorticityProgram.uniforms.uCurl, h.attach(1)), r.uniform1f(o.vorticityProgram.uniforms.curl, R.curl), r.uniform1f(o.vorticityProgram.uniforms.dt, e), x(p.write.fbo), p.swap(), o.divergenceProgram.bind(), r.uniform2f(o.divergenceProgram.uniforms.texelSize, 1 / m, 1 / c), r.uniform1i(o.divergenceProgram.uniforms.uVelocity, p.read.attach(0)), x(b.fbo), o.clearProgram.bind(), r.uniform1i(o.clearProgram.uniforms.uTexture, S.read.attach(0)), r.uniform1f(o.clearProgram.uniforms.value, R.pressure), x(S.write.fbo), S.swap(), o.pressureProgram.bind(), r.uniform2f(o.pressureProgram.uniforms.texelSize, 1 / m, 1 / c), r.uniform1i(o.pressureProgram.uniforms.uDivergence, b.attach(0));
          for (var t = 0; t < R.pressure_iteration; t++) r.uniform1i(o.pressureProgram.uniforms.uPressure, S.read.attach(1)), x(S.write.fbo), S.swap();
          o.gradientSubtractProgram.bind(), r.uniform2f(o.gradientSubtractProgram.uniforms.texelSize, 1 / m, 1 / c), r.uniform1i(o.gradientSubtractProgram.uniforms.uPressure, S.read.attach(0)), r.uniform1i(o.gradientSubtractProgram.uniforms.uVelocity, p.read.attach(1)), x(p.write.fbo), p.swap(), o.advectionProgram.bind(), r.uniform2f(o.advectionProgram.uniforms.texelSize, 1 / m, 1 / c), n.supportLinearFiltering || r.uniform2f(o.advectionProgram.uniforms.dyeTexelSize, 1 / m, 1 / c);
          var i = p.read.attach(0);
          r.uniform1i(o.advectionProgram.uniforms.uVelocity, i), r.uniform1i(o.advectionProgram.uniforms.uSource, i), r.uniform1f(o.advectionProgram.uniforms.dt, e), r.uniform1f(o.advectionProgram.uniforms.dissipation, R.velocity), x(p.write.fbo), p.swap(), r.viewport(0, 0, s, d), n.supportLinearFiltering || r.uniform2f(o.advectionProgram.uniforms.dyeTexelSize, 1 / s, 1 / d);
          r.uniform1i(o.advectionProgram.uniforms.uVelocity, p.read.attach(0)), r.uniform1i(o.advectionProgram.uniforms.uSource, g.read.attach(1)), r.uniform1f(o.advectionProgram.uniforms.dissipation, R.dissipation), x(g.write.fbo), g.swap()
        }(.016);
        w(null);
        requestAnimationFrame(t)
      })(), e.addEventListener("mousemove", function(e) {
        a[0].moved = a[0].down, a[0].dx = 5 * (e.offsetX - a[0].x), a[0].dy = 5 * (e.offsetY - a[0].y), a[0].x = e.offsetX, a[0].y = e.offsetY
      }), e.addEventListener("mousemove", function() {
        a[0].down = !0, a[0].color = L()
      }), window.addEventListener("mouseup", function() {
        a[0].down = !1
      }), window.addEventListener("keydown", function(e) {
        "KeyP" === e.code && (R.paused = !R.paused), " " === e.key && E.push(parseInt(20 * Math.random()) + 5)
      })
    ...
    var m = function() {
        function e(r, n, t) {
          if (a(this, e), this.uniforms = {}, this.webGL = t, this.program = t.createProgram(), t.attachShader(this.program, r), t.attachShader(this.program, n), t.linkProgram(this.program), !t.getProgramParameter(this.program, t.LINK_STATUS)) throw t.getProgramInfoLog(this.program);
          for (var i = t.getProgramParameter(this.program, t.ACTIVE_UNIFORMS), o = 0; o < i; o++) {
